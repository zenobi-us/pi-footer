...
export function getProviderMetadata<TMeta>(entry: UsageStoreEntry): TMeta | undefined {
...
export interface UsageTracker {
  ...
  registerProvider<TMeta = Record<string, unknown>>(provider: ProviderStrategy<TMeta>): void;
